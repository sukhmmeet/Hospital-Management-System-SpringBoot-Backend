...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleUsernameNotFoundException(UsernameNotFoundException exception){
        ApiError apiError = new ApiError("username not found this username : "+exception.getLocalizedMessage(), HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<ApiError> handleIllegalArgumentException(IllegalArgumentException ex) {
        ApiError apiError = new ApiError("Illegal argument: " + ex.getMessage(), HttpStatus.BAD_REQUEST);
